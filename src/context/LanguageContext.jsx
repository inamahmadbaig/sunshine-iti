...
const translations = {
  EN: {
    ...
    principalQuote: "Education is not just about learning facts, but training the mind to think and the hands to create. At Sunshine ITI, we strive to transform students into skilled professionals who drive industrial innovation and growth.",
    principalName: "Sarfaraj Ahmed Baig",
    principalDesg: "Principal, Sunshine ITI College",
    ...
    copyright: "© 2026 Sunshine ITI College. All Rights Reserved.",
  ...
  HN: {
    ...
    welcomeTitle: "सनशाइन आईटीआई कॉलेज में स्वागत है",
    welcomeText1: "सनशाइन आईटीआई कॉलेज मध्य प्रदेश के युवाओं को उच्च गुणवत्ता वाले तकनीकी कौशल प्रदान करने के दृष्टिकोण के साथ स्थापित एक अग्रणी व्यावसायिक प्रशिक्षण संस्थान है। राष्ट्रीय व्यावसायिक प्रशिक्षण परिषद (NCVT), नई दिल्ली से संबद्ध, हम प्रशिक्षण और कौशल विकास के वैश्विक मानकों का पालन करते हैं।",
    ...
    principalDesg: "प्राचार्य, सनशाइन आईटीआई कॉलेज",
    ...
    copyright: "© 2026 सनशाइन आईटीआई कॉलेज। सर्वाधिकार सुरक्षित।",
